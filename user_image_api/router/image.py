...
from user_image_api.model.schema import (ImageOutput, ImageGetOutput,
                                         UserImageUpdateInput, DelUserImageInput,
                                         ThumbUserListOutput, ImageInsertInput
                                         )
...
def add(payload: ImageInsertInput, session: Session = Depends(get_db)):
